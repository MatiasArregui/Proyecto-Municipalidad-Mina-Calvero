# Generated by Django 4.2.21 on 2025-06-03 15:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='InstitucionElemento',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_elemento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='seguridadVial.elementos')),
                ('id_institucion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='seguridadVial.institucion')),
            ],
        ),
        migrations.AddField(
            ...
            name='id_elementos',
            field=models.ManyToManyField(through='seguridadVial.InstitucionElemento', to='seguridadVial.elementos'),
        ),
        migrations.AddField(
            model_name='institucion',
            name='id_persona',
